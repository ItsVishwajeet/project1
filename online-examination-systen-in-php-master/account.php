  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121.JPEG" width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="#" style="color:#202020; font-family:'serif' ; font-size:18px" title="Find on Facebook">Rahul Pawar</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 7030720478</h4>
		<h4 style="font-family:'typo' ">1999rp01@gmail.com</h4>
		<h4 style="font-family:'typo' ">SGM College, Karad</h4></div></div>
		</p>
      </div>
