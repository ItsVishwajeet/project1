...
<h2 align="center" style="font-family:'serif'; color:#000066">FEEDBACK/REPORT A PROBLEM</h2>
...
<div class="col-md-10">
<a href="mailto:chiraggoel.53784@gmail.com" style="color:#000000">1999rp01@gmail.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'serif' "><span style="color:orange">Developers</span></h4>
      </div>
      ...
      <p>
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121_1.JPEG" width=100 height=100 alt="RP" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="#" style="color:red; font-family:'serif' ; font-size:18px" title="Find on Facebook">Rahul Pawar</a>
		<h4 style="color:aquamarine; font-family:'serif' ;font-size:16px" class="title1">+91 7030720478</h4>
		<h4 style="color:aquamarine; font-family:'serif' ">1999rp01@gmail.com</h4>
		<h4 style="color:aquamarine; font-family:'serif' ">SGM College, Karad </h4></div></div>
		</p>
    <h2 style="color:green">--------------------------------------------------</h2>
    <p>
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00122_2.JPG" width=100 height=100 alt="SS" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="#" style="color:red; font-family:'serif' ; font-size:18px" title="Find on Facebook">Shubham Salunkhe</a>
		<h4 style="color:aquamarine; font-family:'serif' ;font-size:16px" class="title1">+91 7028184105</h4>
		<h4 style="color:aquamarine; font-family:'serif' ">ssalunkhe523@gmail.com</h4>
		<h4 style="color:aquamarine; font-family:'serif' ">SGM College, Karad </h4></div></div>
		</p>
      </div>
...
<!--Modal for admin login-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title"><span style="color:orange;font-family:'serif' ">LOGIN</span></h4>
      </div>
