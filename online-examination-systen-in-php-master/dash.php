    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown <?php if(@$_GET['q']==4 || @$_GET['q']==5) echo'active"'; ?>">
          ...
          <ul class="dropdown-menu">
            <li><a href="dash.php?q=1">All users</a></li>
            <li><a href="dash.php?q=0">Total Added Quiz</a></li>
            <li><a href="dash.php?q=2">Ranking vise student</a></li>
            <li><a href="account.php?q=2">Total Solve Quiz</a></li>			
          </ul>
